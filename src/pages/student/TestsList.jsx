...
const TestsList = () =>{
    ...
    useEffect(()=>{
        ...
        setActiveTests([
            ...
            title: 'Mid-Term Exam: Core Syntax',
            questions: 25,
            total_score: 100,
            time_alloted: '60 Minutes'
            },
            {
            test_id: 3,
            course_name: 'Java Masterclass',
            title: 'Unit Test: Object-Oriented Principles',
            questions: 15,
            total_score: 50,
            time_alloted: '30 Minutes'
            }
        ]);
        setIsLoading(false);
        }, 500);
          ...
          activeTests.map((test) => (
            ...
            >
              ...
              <div className="flex items-start gap-5">
                ...
                {/* Text Content */}
                <div>
                  <p className="text-sm font-bold text-blue-600 mb-1 tracking-wide">{test.course_name}</p>
                  <h3 className="text-xl font-bold text-gray-900 mb-3">{test.title}</h3>
                  
                  {/* Metadata Row (Questions, Marks, Time) */}
